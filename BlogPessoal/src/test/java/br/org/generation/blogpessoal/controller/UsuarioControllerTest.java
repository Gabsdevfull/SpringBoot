...
public class UsuarioControllerTest {
	...
	public void deveCriarUmUsuario() {
		...
		HttpEntity<Usuario> requisicao = new HttpEntity<Usuario>(
				new Usuario(0L, "Gabriel Varandas", "Gabriel@gmail.com", "12345678"));
	...
	public void naoDeveDuplicarUsuario() {
		...
		usuarioService.cadastrarUsuario(new Usuario(0L, "Maria da Silva", "mariasilva@email.com.br", "13465278"));

		HttpEntity<Usuario> requisicao = new HttpEntity<Usuario>(
				new Usuario(0L, "Maria da Silva", "mariasilva@email.com.br", "13465278"));
